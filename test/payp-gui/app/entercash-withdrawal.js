...
import WithdrawalEntercashCtx from './components/withdrawal/entercash-withdrawal/WithdrawalEntercashCtx.jsx';
...
const store = getStore({withdrawal});
        ...
        <ThemeProvider theme={theme}>
            <Provider store={ store }>
                <div id="CashierClient" className="outer-wrapper">
                    <NotificationContext/>
                    <AuthContext moduleEntry={ <WithdrawalEntercashCtx/> }/>
                </div>
            </Provider>
        </ThemeProvider>,
